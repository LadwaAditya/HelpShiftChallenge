...
public class Delta implements Parcelable {
    ...
    public static final Creator<Delta> CREATOR = new Creator<Delta>() {
        @Override
        public Delta createFromParcel(Parcel in) {
            return new Delta(in);
        }

        @Override
        public Delta[] newArray(int size) {
            return new Delta[size];
        }
    };
